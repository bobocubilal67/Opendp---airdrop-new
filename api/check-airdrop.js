...
// Test etmek için kendi cüzdanlarını buraya bu formatta ekleyebilirsin.
const userData = {
  "0x71C7656EC7ab88b098defB751B7401B5f6d1476B": {
    "xp": 2500000,
    "roles": ["Alpha Squad", "OG Alpha", "Moderators"] // Çoklu rol seçilebilir
  },
...
export default async function handler(request, response) {
  ...
  // Cüzdan adresi kontrolü (Büyük/küçük harf duyarlılığını kaldırdık)
  ...
  // Yanıtı dönüyor ve reklamı basıyoruz
  return response.status(200).json({
